...
import ScheduleAddModal from "./CustomerScheduleAddModal";
...
/* ------------------------------ */
const title = "Customers Schedule"
/* ------------------------------ */


export default function CustomerScheduleListPage(
  { dbData, 
    centerData 
  }: { 
    dbData: any, 
    ...
    const {
        ...
        getSearchScheduleCustomerDataList,
        search,
        setSearch,
    } = useScheduleStore()
    ...
    const handleSearch = async (e: React.FormEvent<HTMLFormElement>) => {
            e.preventDefault();
            try {
              await getSearchScheduleCustomerDataList(search)
            } catch (error) {
            ...
            <section className="w-full lg:overflow-hidden overflow-scroll">
              <div className='lg:w-[100%] w-[70rem]'>
                ...
                <section className="w-full bg-gray-300 font-bold text-lg border border-gray-400 flex items-center justify-start">
                  <div className="flex-5 border-r border-gray-400 px-2 py-1">CUSTOMER NAME</div>
                ...
                <section key={key} className="w-full border-x border-b border-gray-400 flex items-center justify-start">
                    ...
                    <div className="flex-2 px-2 border-gray-400 py-1 text-end flex items-center justify-end gap-3">
                      ...
                      <Link href={`/admin/schedule/customer/${i.id}`}>
