...
import MyCustomerScheduleAddModal from './MyCustomerScheduleAddModal';
...
export default function MyCustomerScheduleListPage(
  { dbData, 
    centerData 
  }: { 
    dbData: any, 
    centerData: any[] 
      ...
      const {
          ...
          getSearchScheduleByCustomerDataList,
          search,
          setSearch,
      } = useScheduleStore()
      ...
      const handleSearch = async (e: React.FormEvent<HTMLFormElement>) => {
              e.preventDefault();
              try {
                await getSearchScheduleByCustomerDataList(search)
              } catch (error) {
            ...
            <section className="w-full lg:overflow-hidden overflow-scroll">
              <div className='lg:w-[100%] w-[70rem]'>
                ...
                <section className="w-full bg-gray-300 font-bold text-lg border border-gray-400 flex items-center justify-start">
                  <div className="flex-5 border-r border-gray-400 px-2 py-1">CENTER</div>
