...
import FaqAddModal from "./GettingStartedAddModal";
import { FaqData } from "@/_data/sample/FaqData";
import LoaderPrimary from "@/_components/loaders/LoaderPrimary";
import { useGettingStartedStore } from "@/_store/useGettingStartedStore";
import { _gettingStartedDeleteAction } from "@/_actions/GettingStartedActions";
...
/* ------------------------------ */
const title = "Getting Started List"
/* ------------------------------ */
                ...
                {dataList.map((i, key) => (
                  <section key={key} className="w-full border-x border-b border-gray-400 flex items-center justify-start">
                    ...
                    <div className="flex-2 px-2 border-gray-400 py-1 text-end flex items-center justify-end gap-3">
                      ...
                      <Link href={`/admin/getting-started/${i.id}`}>
